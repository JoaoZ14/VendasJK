-- ==========================================
-- Seed de message_templates
-- No SQL Editor, auth.uid() é null.
-- 1) Rode: select id, email from auth.users;
-- 2) Cole o UUID abaixo e execute este script.
-- ==========================================

do $$
declare
  uid uuid := 'COLE-SEU-UUID-AQUI'::uuid;
begin
